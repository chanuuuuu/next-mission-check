  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-12">
      <header className="border-b border-foreground px-4 py-4 sticky top-0 bg-background z-10">
        <Link
          href="/"
          className="font-display text-sm font-bold tracking-tight text-foreground/50 block mb-2"
        >
          ← 처음으로
        </Link>
      ...
      <div className="px-4 py-5 space-y-5">
        ...
        <div>
          <div className="grid grid-cols-2 border border-foreground mb-4">
            <button
              className="font-display font-bold text-sm py-2 tracking-wider bg-foreground text-background"
              disabled
            >
              1층
            </button>
            <button
              className="font-display font-bold text-sm py-2 tracking-wider bg-background text-foreground border-l border-foreground"
              disabled
            >
              2층
            </button>
