  ...
  return (
    <div className="min-h-screen bg-muted flex justify-center">
      <div className="w-full max-w-[480px] bg-background border-x border-foreground min-h-screen flex flex-col animate-[var(--animate-slide-up)]">
        ...
        {/* 헤더 */}
        <header className="px-6 pt-8 pb-6 border-b border-foreground">
        ...
        {/* 하단 고정 */}
        <div className="px-6 py-6 border-t border-foreground bg-background sticky bottom-0">
          {selectedChurch && (
          ...
          <button
            ...
            onClick={() => router.push(`/generate/${selected}`)}
